...
@Component({
  selector: 'app-dashboard-analysisnew',
  templateUrl: './dashboard-analysisnew.component.html',
  styleUrls: ['./dashboard-analysisnew.component.scss']
})
export class DashboardAnalysisnewComponent implements OnInit {
